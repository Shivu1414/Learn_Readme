...
class SellerController extends BaseController
{
    ...
    public function manage(Request $request, CompanyApplication $companyApplication, SellerHelper $sellerHelper)
    {
        ...
        // dd($params);
        // why this line fetch the company .
        ...
        // dd($form->isSubmitted()); false 
        if ($form->isSubmitted() && $form->isValid()) {
            $formData = $form->getData(); 
            // dd($formData);  not working
        ...
        // dd($params);
        // dd($sellerHelper->get_sellers($params));   in index 0 there is mentioned all the listed comapny name.
